import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, watch, nextTick, computed, onScopeDispose, toRefs, defineComponent, Fragment, createVNode, Text, provide, Suspense, mergeProps, Transition, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DWx8PXGQ.js")
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-CZcxy1E4.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B8SYnLcJ.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BlPV1o6v.js"));
